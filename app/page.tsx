    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-white rounded-xl shadow-sm">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-2">
              <p className="text-sm text-slate-500">在籍学员总数</p>
        ...
        <Card className="bg-white rounded-xl shadow-sm">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-slate-900">{todayCoursesCount}</p>
            </div>
        ...
        <Card className="bg-white rounded-xl shadow-sm">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-2">
              <p className="text-sm text-slate-500">本月出勤率</p>
        ...
        <Card className="bg-white rounded-xl shadow-sm">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="space-y-2">
              <p className="text-sm text-slate-500">即将到期学员</p>
                ...
                <div className="space-y-3">
                  {todayCourses.map((course) => {
                    ...
                    return (
                      ...
                      >
                        {/* 时间色块 */}
                        <div className="shrink-0 w-16 h-14 rounded-lg bg-red-50 flex flex-col items-center justify-center text-red-600">
                ...
                {shortcuts.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      className={`flex flex-col items-center justify-center gap-2 rounded-xl p-4 transition-all ${item.color} border border-transparent hover:border-current/10 hover:shadow-sm`}
                    >
